  ...
  return (
    <section id="pipeline" className="py-40 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-24 items-center">
        ...
        <div>
          <span className="font-label text-xs font-bold tracking-[0.3em] uppercase mb-6 block" style={{ color: 'var(--color-primary)' }}>The Agentic Pipeline</span>
          ...
          <ul className="space-y-8">
            <li className="flex items-center gap-6 group">
              <span className="w-8 h-8 rounded-full border flex items-center justify-center group-hover:bg-primary/10 transition-colors" style={{ borderColor: 'rgba(99,102,241,0.3)', color: 'var(--color-primary)' }}>
